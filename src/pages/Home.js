  ...
  return (
    <div>
          ...
          <div className="row">
            <div className="col-lg-6 d-flex flex-column justify-content-center">
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <Link to="/books" className="btn btn-info text-light">
                  Show Books
                </Link>
              </div>
            </div>
      ...
      <div className="container books">
        <div className="kartu mt-5 bg-info">
          <div className="row">
      ...
      <div className="spesial mt-5">
        <div className="container books">
          <div className="kartu2 bg-info">
            <div className="row">
              <div className="col-md-3 col-sm-6 item bg-2">
                <div className="card item-card card-block">
                  <h4 className="card-title text-right">
